    ...
    <section class="content invoice">
        ...
        <div class="row">
            <div class="col-xs-12">
                <h2 class="page-header">
                    ...
                    Laporan Kasus Anak
                    <span class="pull-right small"><label class="label label-danger">Form KA5</label></span>
                </h2>
        ...
        <div class="row no-print">
            <div class="col-xs-12" style="margin-top:61px;">
                <a href="{{URL::to('lpantb/formka5')}}" class="btn btn-primary"><i class="fa fa-chevron-left"></i> Back</a>
