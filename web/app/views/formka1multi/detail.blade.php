...
<aside class="right-side">
    ...
    <section class="content invoice">
        ...
        <div class="row invoice-info">
            ...
            @include('formka1multi.detail.pelapor')
            @include('formka1multi.detail.anak')
            @include('formka1multi.detail.ringkasan')
            @include('formka1multi.detail.sign')
        </div><!-- /.row -->

        <div class="row no-print">
            <div class="col-xs-12" style="margin-top:61px;">
              <?php $lka = base64_encode($data->no_lka); ?>
                <a href="{{URL::to('lpantb/formka1multi/view/'.$lka)}}" class="btn btn-primary"><i class="fa fa-chevron-left"></i> Back</a>
